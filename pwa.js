...
const cacheName = 'GA_LAWK4_Thomas_Parker-2021-02-24 15:26:15.523147'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'GA_LAWK4_Thomas_Parker'.length) === 'GA_LAWK4_Thomas_Parker') {
